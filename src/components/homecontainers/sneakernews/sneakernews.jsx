...
const SneakerNewsContainer = () => {
  ...
  const fetchData = async () => {
    const url =
      "https://newsapi.org/v2/everything?from=2023-11-28&to=2023-11-28&sortBy=popularity&apiKey=961915f9b4704edfb1854ff5d0c69f1e&language=en&q=nike&searchIn=title&domains=nicekicks.com,sneakernews.com,trendhunter.com,footwearnews.com";
